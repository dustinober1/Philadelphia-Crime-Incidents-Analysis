...
**Status**: 📋 Planned (8 plans in 3 waves)
...
**Plans:**
- [ ] 12-01-PLAN.md — Test Trends API Endpoints (5 endpoints: annual, monthly, covid, seasonality, robbery-heatmap)
- [ ] 12-02-PLAN.md — Test Spatial API Endpoints (4 endpoints: districts, tracts, hotspots, corridors)
- [ ] 12-03-PLAN.md — Test Policy API Endpoints (4 endpoints: retail-theft, vehicle-crimes, composition, events)
- [ ] 12-04-PLAN.md — Test Forecasting API Endpoints (2 endpoints: time-series, classification)
- [ ] 12-05-PLAN.md — Test API Service Layer (data_loader.py unit tests with mocked file I/O)
- [ ] 12-06-PLAN.md — Test CLI Main Commands (version, info)
- [ ] 12-07-PLAN.md — Test API Error Handling (422, 401, 404, 429, 500, CORS, middleware)
- [ ] 12-08-PLAN.md — Generate API & CLI Coverage Report (verify 80-85% milestone)
...
| 12 - API & CLI | 📋 Planned | 8 plans (8/8 reqs) | 80-85% |
