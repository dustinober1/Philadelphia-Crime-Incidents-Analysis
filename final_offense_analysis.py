#!/usr/bin/env python3
"""
Final script to execute the offense breakdown analysis
"""
...
# Rename the period column and convert to timestamp
monthly_trends = monthly_trends.rename(columns={monthly_trends.columns[0]: "period"})
monthly_trends["date"] = monthly_trends["period"].dt.to_timestamp()
...
# Rename the period column and convert to timestamp
top_offense_trends = top_offense_trends.rename(
    columns={top_offense_trends.columns[0]: "period"}
)
top_offense_trends["date"] = top_offense_trends["period"].dt.to_timestamp()
...
print("- 12 figures saved in output/figures/offense/")
print("- 10 tables saved in output/tables/offense/")
print("- UCR code distribution and mapping completed")
print("- Severity classification and validation completed")
print("- 20-year offense trends with confidence intervals calculated")
print("- Seasonality analysis by offense type completed")
print("- Cross-temporal offense pattern analysis completed")
