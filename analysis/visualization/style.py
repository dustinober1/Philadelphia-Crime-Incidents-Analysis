"""Centralized matplotlib style configuration for crime analysis visualizations.

This module provides a unified styling approach for all plots generated by the
crime analysis project. It imports the project's color palette from analysis.config
and configures matplotlib with publication-quality settings.

Usage:
    >>> from analysis.visualization.style import setup_style, COLORS
    >>> setup_style()  # Apply style settings
